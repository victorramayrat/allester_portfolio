        ...
        <div className="mx-auto justify-center max-w-5xl pt-8 sm:pt-16 px-4 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
            ...
            <div className="lg:order-first lg:row-span-2">
              ...
              <p>As a starting software engineer, I am proficient with backend using Python and have working knowledge of ReactJs (NextJs/Tailwind CSS, like this site). I am familiar with GCP and AWS, as well as other providers like Supabase and Digital Ocean.</p>
              <p>While I am in the hunt for my next role, I've co-founded a <a className="font-semibold text-yellow-600" href="https://thedxcompany.com" target="_blank">data analytics engineering studio and technology lab</a>. I believe that being in motion expands my chance of success in life. It also allows me develop marketable skills and test-build emerging technologies (like GenAI).</p>
