        ...
        <AnimationOnScroll animateIn="animate-fade" animateOnce="true">
          <div className="mx-auto max-w-5xl pt-16 sm:pt-32 px-4 sm:px-8 lg:px-12">
            ...
            <div className="mx-auto mt-16">
                  ...
                  <a className="z-0" href='https://www.ccber.ucsb.edu/' target="_blank">
                    <div className="md:grid md:grid-cols-4 md:items-baseline">
                        <Card className="md:col-span-3">
                          ...
                          <Items>
                            <Card.Cta link='/' className="float-left" >Interim Report</Card.Cta>
              ...
              <div className="mt-8">
                <p className="text-base w-fit z-10 font-semibold tracking-tight text-zinc-800 dark:text-zinc-100 hover:text-teal-500 transition hover:scale-110">
                  View Full Resume
                </p>
              </div>
            </div>
